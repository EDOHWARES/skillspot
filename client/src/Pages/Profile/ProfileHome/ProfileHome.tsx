  ...
  return (
    <div className="robotoFlex">
      ...
      <section>
        ...
        <Link to={'/profile/editName'} className="h-[63px] w-full flex items-center justify-between bg-white px-2 md:px-10 mt-[.2rem] cursor-pointer hover:scale-95 hover:bg-gray-50 duration-500">
