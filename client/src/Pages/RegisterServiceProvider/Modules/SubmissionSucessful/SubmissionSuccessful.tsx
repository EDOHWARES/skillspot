...
interface SubmissionSuccessfulPropTypes {
  hideModal: () => void;
}
...
const SubmissionSuccessful: React.FC<SubmissionSuccessfulPropTypes> = ({hideModal}) => {
  return (
    ...
    <div className="shadow w-full bg-white flex items-center h-fit self-end flex-col gap-4 rounded-[9px] py-4 md:w-2/3 mx-auto">
      ...
      <button onClick={hideModal} className="bg-[#282828] cursor-pointer text-[16px] font-semibold text-white px-4 py-2 w-[224px] h-[52px] flex items-center justify-center rounded-[6px]">
        Okay
      </button>
    </div>
  </section>
